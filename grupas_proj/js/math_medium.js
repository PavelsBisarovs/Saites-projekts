document.getElementById('test-title').textContent = 'Matemātika — Vidējs līmenis';

const allQuestions = [
    { q: "5 + (3 × 2) = ?", options: ['11', '10', '9'], answer: '11' },
    { q: "12 ÷ 4 + 2 = ?", options: ['5', '4', '6'], answer: '5' },
    { q: "x + 3 = 7, x = ?", options: ['4', '3', '5'], answer: '4' },
    { q: "15 - 6 ÷ 3 = ?", options: ['13', '11', '9'], answer: '13' },
    { q: "1/2 + 1/4 = ?", options: ['3/4', '1/4', '2/3'], answer: '3/4' },
    { q: "2x = 10, x = ?", options: ['5', '10', '4'], answer: '5' },
    { q: "(3 + 2) × 2 = ?", options: ['10', '12', '8'], answer: '10' },
    { q: "10 - (2 + 3) = ?", options: ['5', '4', '6'], answer: '5' },
    { q: "(6 + 4) ÷ 2 = ?", options: ['5', '6', '4'], answer: '5' },
    { q: "7 + 3 × 2 = ?", options: ['13', '17', '14'], answer: '13' },
    { q: "3² + 1 = ?", options: ['10', '8', '9'], answer: '10' },
    { q: "√36 = ?", options: ['6', '5', '4'], answer: '6' },
    { q: "1/3 + 1/3 = ?", options: ['2/3', '1/2', '1'], answer: '2/3' },
    { q: "10 - 2 × 4 = ?", options: ['2', '6', '4'], answer: '2' },
    { q: "6 + 12 ÷ 4 = ?", options: ['9', '12', '10'], answer: '9' }
];

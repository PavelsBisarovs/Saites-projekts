document.getElementById('test-title').textContent = 'Matemātika — Sarežģīts līmenis';

const allQuestions = [
    { q: "(2 + 3)^2 = ?", options: ['25', '10', '15'], answer: '25' },
    { q: "√81 = ?", options: ['9', '8', '7'], answer: '9' },
    { q: "3x - 2 = 4, x = ?", options: ['2', '1', '3'], answer: '2' },
    { q: "(6 × 6) - 6 = ?", options: ['36', '30', '28'], answer: '30' },
    { q: "2^4 = ?", options: ['8', '16', '12'], answer: '16' },
    { q: "(7 + 5) / 3 = ?", options: ['4', '3', '5'], answer: '4' },
    { q: "(9 - 3)^2 = ?", options: ['36', '18', '9'], answer: '36' },
    { q: "10x = 100, x = ?", options: ['10', '20', '5'], answer: '10' },
    { q: "(8 / 2) + 6 = ?", options: ['10', '9', '8'], answer: '10' },
    { q: "√49 + √16 = ?", options: ['11', '12', '13'], answer: '11' },
    { q: "(5^2 - 3) / 2 = ?", options: ['11', '10', '9'], answer: '11' },
    { q: "x² = 49, x = ?", options: ['7', '6', '8'], answer: '7' },
    { q: "(2 + 3) × (4 - 1) = ?", options: ['15', '12', '10'], answer: '15' },
    { q: "6x + 2 = 20, x = ?", options: ['3', '2', '4'], answer: '3' },
    { q: "√100 + 2^3 = ?", options: ['18', '16', '14'], answer: '18' }
];
